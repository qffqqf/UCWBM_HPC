...
N_UC_x = 5;% Amount of UCs in X-direction
N_UC_y = 5;% Amount of UCs in Y-direction
...
response_UC_x = 3; % Which UC in the x-direction
response_UC_y = 3; % Which UC in the y-direction
