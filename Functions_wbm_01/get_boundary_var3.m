function modes_bd = get_boundary_var3(N_UC_x, N_UC_y, lambdas, phases, ...
                                      bloch_modes, UC_dofs, wave_id)
%% Get local modes
...
modes_global_Bc = modes_global_B(:,[wave_id.p,wave_id.eB]);
sigma = svd(modes_global_Bc);
